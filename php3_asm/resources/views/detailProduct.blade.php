...
{{--    <div>--}}
{{--        <img class="object-scale-down w-96" src="/images/{{$data->product_image}}" alt="image description">--}}
{{--    </div>--}}
{{--    <div class="m-2">--}}
{{--        <div class="mb-5">--}}
{{--            <h1 class="text-2xl text-pink-500 font-medium">{{$data->product_name}}</h1>--}}
{{--        </div>--}}
{{--        <div class="mb-5">--}}
{{--            <h2>{{$data->product_price}} đ</h2>--}}
{{--        </div>--}}
{{--        <div class="mb-5">--}}
{{--            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-96">Thêm vào giỏ hàng</button>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
<!-- component -->
